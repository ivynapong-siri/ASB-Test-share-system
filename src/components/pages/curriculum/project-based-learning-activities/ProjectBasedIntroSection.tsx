...
interface ProjectBasedIntroSectionProps {
  introData: SectionJson;
  breadcrumbData: BreadcrumbProps;
}

export default function ProjectBasedIntroSection({ introData, breadcrumbData }: ProjectBasedIntroSectionProps) {
  return (
    <IntroSection
      ...
      vectorChildren={
        <>
          ...
          <PatternStroke1 className="absolute -bottom-30 -left-13 h-[74px] w-[166px] lg:bottom-8 lg:h-[148px] lg:w-[333px]" />
        </>
      }
    />
  );
