...
interface AdvancedPlacementIntroSectionProps {
  introData: SectionJson;
  breadcrumbData: BreadcrumbProps;
}

export default function AdvancedPlacementIntroSection({
  introData,
  breadcrumbData,
}: AdvancedPlacementIntroSectionProps) {
  return (
    <IntroSection
      ...
      haveButton
      buttonConfig={{
        buttonText: introData.buttonLabel ?? "",
        href: introData.buttonLabel ?? "",
      }}
      ...
      vectorChildren={
        <>
          <PatternStroke1 className="absolute top-12 -right-40 h-32 w-64 lg:-top-20 lg:-right-60 lg:h-[265px] lg:w-[360px] xl:-top-30" />
          <PatternStroke1 className="absolute -bottom-30 -left-13 h-[74px] w-[166px] lg:bottom-0 lg:h-[148px] lg:w-[333px]" />
        </>
      }
    />
  );
