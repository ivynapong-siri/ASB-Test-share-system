...
interface AllDetailSharedSectionProps {
  buttonLabel?: string;
  title?: string;
  onOpen: () => void;
}

const AllDetailSharedSection = ({ buttonLabel, title, onOpen }: AllDetailSharedSectionProps) => {
  return (
...
export default AllDetailSharedSection;
